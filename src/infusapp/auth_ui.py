...
class Auth_Ui:
    def __init__(self):
        self.actual_nurse = None  # Logged in Nurse Name
        self.his = His()
    ...
    def login_screen(self):
        ...
        if self.his.val_nurse_id(user_input):
            nurse_id = user_input
            try:
                actual_nurse = self.his.login_nurse(nurse_id=nurse_id, pw=pw)
            except ValueError as errormessage:
                print(errormessage)
                return self.start_screen()
        # Nurse Name was entered
        elif self.his.val_nurse_name(user_input):
            nurse_name = user_input
            try:
                actual_nurse = self.his.login_nurse(nurse_name=nurse_name, pw=pw)
            except ValueError as errormessage:
                print(errormessage)
                return self.start_screen()
       # When neither ID or Name recognized
        ...
        home_ui = Home_Ui(self.actual_nurse)
    ...
    def register_screen(self):
        ...
        if pw == rpw:
            try:
                new_nurse = self.his.register_nurse(nurse_name, pw)
            except ValueError as errormessage:
                print(errormessage)
                return self.register_screen()
            else:
